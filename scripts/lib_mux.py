...
Backends:
  ...
  HerdrBackend — stub (NotImplemented, Phase 2)
...
# ---------------------------------------------------------------------------
# HerdrBackend (Phase 2 stub)
# ---------------------------------------------------------------------------

class HerdrBackend(_Backend):
    """herdr backend — Phase 2 stub. All verbs return failure."""
    ...
    def spawn(self, name, cmd, cwd=None, env=None):
        self._warn("HerdrBackend not yet implemented (Phase 2)")
        return False
